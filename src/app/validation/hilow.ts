...
@Directive({
    ...
    providers: [
        {
            provide: NG_VALIDATORS, // Без этого провайдера не будет валидатор работать. Директивы валидации должны использовать этот сервис
...
export class HiLowValidatorDirective implements Validator {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if ("high" in changes || "low" in changes) {
            ...
            let loval =
                typeof this.low == "string" ? parseInt(this.low) : this.low;
